...
// this is a componment is responsible for the visual display the progress of file upload 

const ProgressList = ({ files }) => {
    return(
        <ImageList rowHeight={200} 
            sx={{
                '&.MuiImageList-root':{ // using styling from MUI
                    gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))!important', // changing the grid template columns 
                },
            }}
        >
