...
const userSchema = Schema({// initialisig the schema of the user 
    name: { type: String, min: 2, max: 50, required: true }, // defining the structure and requirments for the name and other fields
    email: { type: String, min: 5, max: 50, required: true, unique: true, trim:true }, // email must be unique 
...
const User = mongoose.model('users', userSchema); // assignming the User modal with name and the userSchema
